...
/**
 * Base class that represents a row from the 'import_history' table.
 *
 *
 *
 * @package    propel.generator.Propel.Base
 */
abstract class ImportHistory implements ActiveRecordInterface
{
    /**
     * TableMap class name
     *
     * @var string
     */
    public const TABLE_MAP = '\\Propel\\Map\\ImportHistoryTableMap';
    ...
    {
        $this->count_imported_products = 0;
        $this->count_errors = 0;
    }

    /**
     * Initializes internal state of Propel\Base\ImportHistory object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>ImportHistory</code> instance.  If
     * <code>obj</code> is an instance of <code>ImportHistory</code>, delegates to
     * <code>equals(ImportHistory)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    public function getImportedAt($format = null)
    {
        if ($format === null) {
            ...
            return $this->imported_at instanceof \DateTimeInterface ? $this->imported_at->format($format) : null;
        }
    }
    ...
    {
        return $this->count_imported_products;
    }
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[ImportHistoryTableMap::COL_ID] = true;
        }
    ...
    public function setFileId($v)
    {
        ...
        if ($this->file_id !== $v) {
            $this->file_id = $v;
            $this->modifiedColumns[ImportHistoryTableMap::COL_FILE_ID] = true;
        }
     ...
     * @return $this The current object (for fluent API support)
     */
    public function setImportedAt($v)
    {
        $dt = PropelDateTime::newInstance($v, null, 'DateTime');
        if ($this->imported_at !== null || $dt !== null) {
            if ($this->imported_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->imported_at->format("Y-m-d H:i:s.u")) {
                $this->imported_at = $dt === null ? null : clone $dt;
                $this->modifiedColumns[ImportHistoryTableMap::COL_IMPORTED_AT] = true;
            }
    ...
    public function setStatus($v)
    {
        ...
        if ($this->status !== $v) {
            $this->status = $v;
            $this->modifiedColumns[ImportHistoryTableMap::COL_STATUS] = true;
        }
    ...
    public function setCountImportedProducts($v)
    {
        ...
        if ($this->count_imported_products !== $v) {
            $this->count_imported_products = $v;
            $this->modifiedColumns[ImportHistoryTableMap::COL_COUNT_IMPORTED_PRODUCTS] = true;
        }
    ...
    public function setCountErrors($v)
    {
        ...
        if ($this->count_errors !== $v) {
            $this->count_errors = $v;
            $this->modifiedColumns[ImportHistoryTableMap::COL_COUNT_ERRORS] = true;
        }
    ...
    {
            if ($this->count_imported_products !== 0) {
                return false;
            }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ImportHistoryTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload(bool $deep = false, ?ConnectionInterface $con = null): void
    {
        ...
        $dataFetcher = ChildImportHistoryQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws \Propel\Runtime\Exception\PropelException
     * @see ImportHistory::setDeleted()
     * @see ImportHistory::isDeleted()
     */
    public function delete(?ConnectionInterface $con = null): void
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildImportHistoryQuery::create()
    ...
    public function save(?ConnectionInterface $con = null): int
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ImportHistoryTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(ImportHistoryTableMap::COL_ID)) {
        ...
        if ($this->isColumnModified(ImportHistoryTableMap::COL_STATUS)) {
            $modifiedColumns[':p' . $index++]  = 'status';
        }
        if ($this->isColumnModified(ImportHistoryTableMap::COL_COUNT_IMPORTED_PRODUCTS)) {
            $modifiedColumns[':p' . $index++]  = 'count_imported_products';
        }
        if ($this->isColumnModified(ImportHistoryTableMap::COL_COUNT_ERRORS)) {
            $modifiedColumns[':p' . $index++]  = 'count_errors';
        }

        $sql = sprintf(
            'INSERT INTO import_history (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'log':
                        ...
                        break;
                    case 'imported_at':
                        $stmt->bindValue($identifier, $this->imported_at ? $this->imported_at->format("Y-m-d H:i:s.u") : null, PDO::PARAM_STR);
                    ...
                    case 'status':
                        ...
                        break;
                    case 'count_imported_products':
                        $stmt->bindValue($identifier, $this->count_imported_products, PDO::PARAM_INT);

                        break;
                    case 'count_errors':
                        $stmt->bindValue($identifier, $this->count_errors, PDO::PARAM_INT);
    ...
    {
        $pos = ImportHistoryTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ImportHistory'][$this->hashCode()])) {
            return ['*RECURSION*'];
        }
        $alreadyDumpedObjects['ImportHistory'][$this->hashCode()] = true;
        $keys = ImportHistoryTableMap::getFieldNames($keyType);
        $result = [
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(ImportHistoryTableMap::COL_ID)) {
            $criteria->add(ImportHistoryTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(ImportHistoryTableMap::COL_FILE_ID)) {
        ...
        if ($this->isColumnModified(ImportHistoryTableMap::COL_STATUS)) {
            $criteria->add(ImportHistoryTableMap::COL_STATUS, $this->status);
        }
        if ($this->isColumnModified(ImportHistoryTableMap::COL_COUNT_IMPORTED_PRODUCTS)) {
            $criteria->add(ImportHistoryTableMap::COL_COUNT_IMPORTED_PRODUCTS, $this->count_imported_products);
        }
        if ($this->isColumnModified(ImportHistoryTableMap::COL_COUNT_ERRORS)) {
            $criteria->add(ImportHistoryTableMap::COL_COUNT_ERRORS, $this->count_errors);
        }
    ...
    {
        $criteria = ChildImportHistoryQuery::create();
        $criteria->add(ImportHistoryTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of \Propel\ImportHistory (or compatible) type.
    ...
    public function copyInto(object $copyObj, bool $deepCopy = false, bool $makeNew = true): void
    {
        ...
        $copyObj->setCountErrors($this->getCountErrors());
        if ($makeNew) {
            $copyObj->setNew(true);
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Propel\ImportHistory Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    ...
    {
        if ($this->aFiles === null && ($this->file_id != 0)) {
            $this->aFiles = ChildFilesQuery::create()->findPk($this->file_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aFiles->addImportHistories($this);
             */
        }
    ...
    {
        if (null !== $this->aFiles) {
            $this->aFiles->removeImportHistory($this);
        }
        $this->id = null;
        $this->file_id = null;
        $this->log_file = null;
    ...
    {
        return (string) $this->exportTo(ImportHistoryTableMap::DEFAULT_STRING_FORMAT);
    }
